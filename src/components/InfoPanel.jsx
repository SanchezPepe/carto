  ...
  if (isMobile) {
    return (
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4" onClick={onClose}>
        ...
        {/* Modal Card */}
        <div
          className="relative w-full max-w-sm glass-panel rounded-2xl overflow-hidden animate-fade-in"
            ...
            <div className="flex items-start justify-between">
              <div>
                <div className="flex items-center gap-2 mb-1">
                  <span className="badge badge-emerald text-xs">{selectedRegion.id}</span>
          ...
          <div className="p-4">
            ...
            <div className="text-center mb-4">
              ...
              {stats && (
                <p className={`text-sm mt-1 ${
                  ...
                  {vsAverage > 0 ? '+' : ''}{formatNumber(vsAverage, dataset?.unit)} vs promedio
                </p>
              )}
            </div>
            ...
            {stats && (
              <div className="grid grid-cols-3 gap-2 mb-4">
                <div className="bg-gray-50 dark:bg-gray-800/50 rounded-xl p-2 text-center">
                  <p className="text-[10px] text-gray-500 dark:text-gray-400 uppercase">Ranking</p>
                  <p className="text-base font-bold text-gray-900 dark:text-white">
                    #{stats.total - stats.rank + 1}
                  </p>
                </div>
                <div className="bg-gray-50 dark:bg-gray-800/50 rounded-xl p-2 text-center">
                  <p className="text-[10px] text-gray-500 dark:text-gray-400 uppercase">Percentil</p>
                  <p className="text-base font-bold text-gray-900 dark:text-white">
